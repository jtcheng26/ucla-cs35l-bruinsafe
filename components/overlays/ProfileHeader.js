...
export default function ProfileHeader({ onLogout }) {
  ...
  const styles = {
    ...
    inputField:
      "text-white p-2 w-12/12 m-2 justify-start border-b-2 border-blue-200",
  };
  ...
  return (
    <>
      ...
      >
        <SafeAreaView className="w-screen h-2/5 bg-blue-900 rounded-3xl flex-col items-center">
          <Text className="text-white mt-8 text-4xl font-bold text-center">
            Edit Your Profile
          </Text>

          <View className="w-11/12 mt-4">
            <Text className={styles.inputText}>Name:</Text>
            <TextInput
          ...
          <View className="w-full absolute bottom-2">
            <View className="flex-row-reverse">
              ...
              >
                <Check width={45} height={45} fill="#FFF" />
              </TouchableScale>
              <TouchableScale
              ...
              >
                <Cancel width={20} height={20} fill="#FFF" />
              </TouchableScale>
              <TouchableScale
              ...
              >
                <Text className="text-blue-300 ">Logout</Text>
              </TouchableScale>
            </View>
          </View>
        </SafeAreaView>
      </Modal>
      <SafeAreaView className="absolute top-14 left-2">
        <TouchableScale
          className="flex-row w h-12 items-center"
          activeScale={0.97}
          onPress={() => setScreenVisible(true)}
        >
          <View className="bg-white rounded-full mr-4 ml-4">
            <Image source={pfp} className="w-8 h-8" />
          </View>
