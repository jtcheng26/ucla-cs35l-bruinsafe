...
export default function walkButton({onPress, text, setMarker, setMarkerStyle, region, markerList, setMarkerList, regionCoords, walkPath, setWalkPath, curLocation, setWaiting}) {
