...
export default function confirmPath({onPress, coordinates, setMarkerList, setThePath, copyPath, setWalking, setWaiting, waiting, setCurrentWalker, setCurrentWalkId}) {
    const { id } = useUserId(); 
